...
console.log(mergeSort([9, 81, 729]));
console.log(mergeSort([-2, 3, 1]));
console.log(mergeSort([5, -2, 6]));
console.log(mergeSort[-1, -2, -10, 5]);
console.log(mergeSort[5, 6, -7]);
console.log(mergeSort([6, -9, 2]));
console.log(mergeSort([-2, 3, 4]));
console.log(mergeSort[5, -2 ,6]);
console.log(mergeSort[5, 6, -2]);
console.log(mergeSort([3, -6, 9]));
console.log(mergeSort(-2, -3, -4));
console.log(mergeSort([5, -9, -100]));
console.log(mergeSort([5, -6, -1]));
